...
| Feature                      | Description                                                                                      |
| ---------------------------- | ------------------------------------------------------------------------------------------------ |
| Payment Sequential           | Customer may pay an order with more than one payment method. If so, a sequence is created to accommodate all payments. |
...
| Product Weight (grams)       | Weight of the product measured in grams.                                                         |
